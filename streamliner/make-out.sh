...
mvn exec:java --quiet --update-snapshots -Dexec.mainClass=dk.casa.streamliner.asm.TransformASM
cp -R out/asm/. out/classes

mvn package --update-snapshots -Dmaven.main.skip "-Dnumbers=${NUMBERS}" "-Diterations=${ITERATIONS}" "-Dwarmups=${WARMUPS}"
