...
# @todo #63:30min Code duplication streamliner-jits and streamliner-jvms
#  These two directories have almost identical scripts.
#  We need to refactor them to remove code duplication.
set -e -o pipefail
